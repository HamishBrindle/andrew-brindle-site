...
<p align="center">
  This is not an official project. It's made by <a href="https://andrewbrindle.com/">Andrew Brindle</a> and you can contribute submitting a pull-request.
  </a>
</p>
...
1.  **Clone this repository.**
    ...
    ```sh
    git clone https://github.com/andrewbrindle/nuxt-markdown-blog-starter.git
    ```
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/andrewbrindle/nuxt-markdown-blog-starter)